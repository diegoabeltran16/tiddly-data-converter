...
Usage:
  python3 src/python_scripts/audit_normative_projection.py --help
  python3 src/python_scripts/audit_normative_projection.py --mode audit --input-root data/out/local --docs-root docs
  python3 src/python_scripts/audit_normative_projection.py --mode apply --input-root data/out/local --docs-root docs
...
Examples:
  ...
  python3 src/python_scripts/audit_normative_projection.py --mode audit --input-root data/out/local --audit-dir data/out/local/audit

  # Skip layer regeneration even in apply mode:
  python3 src/python_scripts/audit_normative_projection.py --mode apply --no-regenerate
""",
    )
    parser.add_argument(
        "--mode",
