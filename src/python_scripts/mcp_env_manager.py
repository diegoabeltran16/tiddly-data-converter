...
def action_preview_pull() -> None:
    ...
    print("  Admision      : src/python_scripts/admit_session_candidates.py")
...
def action_pull_and_admit() -> None:
    ...
    if candidates:
        ...
        print("  Comando: python3 src/python_scripts/admit_session_candidates.py dry-run --all-contracts")
