...
# Usage (interactive): bash src/shell_scripts/pick_and_place.sh -s <source-dir>
# Usage (batch):       bash src/shell_scripts/pick_and_place.sh -n "<file1>,<file2>" -d docs/tiddlers_esp
