...
#
# Usage:
#   ./src/shell_scripts/export_s33_verify.sh
#
# Checks (delegated to src/python_scripts/verify_export_counts.py):
...
python3 "${REPO_ROOT}/src/python_scripts/verify_export_counts.py" \
  --jsonl "${JSONL}" \
  --manifest "${MANIFEST}"
